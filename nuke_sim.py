...
def generate_lineups(players,n_lineups=600,min_salary=None,seed=26,site="DK",flex_position=None,locked_indices=None,no_offense_vs_dst=True):
    ...
    # The caller owns this setting. A removed legacy sidebar widget used the
    # nuke_engine_flex_position session key and could silently force the engine
    # back to ANY after the user selected RB/WR/TE in the current control.
